...
extern void abort_and_exit(char *msg);
#define ABORT(err_msg) abort_and_exit(err_msg)
/* #define ABORT(err_msg) superlu_abort_and_exit(err_msg) */
...
#ifndef USER_FREE
#define USER_FREE(addr) FREE(addr)
#endif
