***************************** -*- Mode: Fortran -*- ********************
*
* bcs.f -- Interface routines for BCSLIB.
* 
...
*
* $Id: bcs.f,v 1.1.1.1 1996/04/17 05:56:15 ksh Exp $
*
************************************************************************
*
...
*
     ...
     1        NHOLD, SQFILE, WAFIL1, WAFIL2, IER, MTXTYP
      COMPLEX*16 HOLD(*)
*
      CALL HZSLIN( NEQNS, CHAR(MTXTYP), MSGLVL, IPU,
     1             SQFILE, WAFIL1, WAFIL2, HOLD, NHOLD, IER )
*
      RETURN
      END
...
*
      CALL HDSLIN( NEQNS, CHAR(MTXTYP), MSGLVL, IPU,
     1             SQFILE, WAFIL1, WAFIL2, HOLD, NHOLD, IER )
*
      RETURN
      END
